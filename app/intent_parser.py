...
_ALIAS_MAP: dict[str, str] = {
    ...
    "研華": "2395",
    # ETF
    "台灣50": "0050", "元大台灣50": "0050", "0050": "0050",
    "高股息": "0056", "元大高股息": "0056", "0056": "0056",
    ...
    "特斯拉": "TSLA", "tesla": "TSLA",
    "輝達": "NVDA", "nvidia": "NVDA", "nvdia": "NVDA",
...
def _ask_gpt(message: str) -> dict:
    ...
    try:
        ...
        system_prompt = (
            ...
            "- help: 詢問怎麼使用服務\n"
            "- unknown: 完全無關股票的問題\n\n"
            "股票代號規則：台股用數字代號（如2330），美股用英文（如AAPL）。\n"
            "若訊息中有公司名稱，轉換成代號；若找不到，stock_code 填 null。"
        )
